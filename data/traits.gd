...
## 사망 시 폭발 피해. 인접 4칸이 **적아 구분 없이** 맞는다.
##
## 구분을 두면 "적 자폭체 옆에 적이 서 있어도 안전" 이 되어, 플레이어가 몰아
## 놓고 터뜨리는 그림이 안 나온다. 구분이 없어야 폭발이 판 위의 사건이 된다.
const VOLATILE_DAMAGE: int = 20
...
const TEXT: Dictionary = {
	...
	VOLATILE: "자폭 - 죽으면 인접 4칸에 %d 피해 (적아 무관)" % VOLATILE_DAMAGE,
