...
const TABLE: Dictionary = {
	...
	"frontbreak": {
		...
		"cond": "always",
		"cond_arg": 0,
		"pick": "locked_frontline_enemy",
		"text": "교전 시작 시 가장 가까운 적을 끝까지 쫓는다",
	},
	"hunt_hidden": {
		"axis": "target",
		"tag": "none",
		...
		"cond": "always",
		"cond_arg": 0,
		"pick": "ambushing_enemy",
		"text": "숨은 적을 찾아 친다. 다른 모듈로는 숨은 적을 고를 수 없다",
	},
	"frail_hunt": {
		"axis": "target",
		"tag": "rear",
	...
	"run_down": {
		...
		"cond_arg": 30,
		"stand": "chase",
		"text": "표적(표적 모듈이 정한 적) HP < 30% → 이동 +1로 쫓는다",
	},
	"behind_guard": {
		"axis": "position",
		"tag": "formation",
	...
	"cover_ranged": {
		...
		"cond": "always",
		"cond_arg": 0,
		"stand": "protect_ranged",
		"text": "사거리가 가장 긴 아군 곁을 지킨다",
	},
	"escort": {
		"axis": "position",
		"tag": "spread",
